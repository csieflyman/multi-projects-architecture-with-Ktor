...
object Jackson {
    ...
    fun toJson(data: Any): JsonNode {
        return try {
            ...
            throw InternalServerErrorException(ResponseCode.ENTITY_JSON_INVALID, "fail to json serialize", e)
        }
    }
    ...
    fun parse(src: String): JsonNode {
        return try {
            ...
            throw InternalServerErrorException(ResponseCode.ENTITY_JSON_INVALID, "fail to parse json", e)
        }
    }
