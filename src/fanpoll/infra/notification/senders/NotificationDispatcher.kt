...
class NotificationDispatcher(
    ...
    private val i18nNotificationMessagesProvider: I18nNotificationMessagesProvider,
        ...
        return with(notification) {
            type.channels.flatMap { channel ->
                ...
                langs.mapNotNull { lang ->
                    val i18nMessages = i18nNotificationMessagesProvider.preferred(lang)
