...
package fanpoll.infra.openapi.route
...
@KtorDsl
fun Route.delete(operation: RouteApiOperation, body: PipelineInterceptor<Unit, ApplicationCall>): Route {
    operation.bindRoute(
...
@KtorDsl
fun Route.delete(path: String, operation: RouteApiOperation, body: PipelineInterceptor<Unit, ApplicationCall>): Route {
    operation.bindRoute(
...
@KtorDsl
inline fun <reified LOCATION : Any, reified REQUEST : Form<*>, reified RESPONSE : Any> Route.postWithLocation(
    operation: RouteApiOperation,
